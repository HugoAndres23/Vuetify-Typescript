...
import {
    readDashboardMiniDrawer, readDashboardShowDrawer, readHasAdminAccess
} from '@/store/main/getters'
import {
    commitSetDashboardShowDrawer, commitSetDashboardMiniDrawer
} from '@/store/main/mutations'
import {
    dispatchUserLogOut
} from '@/store/main/actions'
import {
    Route, NavigationGuardNext
} from 'vue-router'

const routeGuardMain = async (to: Route, from: Route, next: NavigationGuardNext) => {
    if (to.path === '/main') {
        next('/main/dashboard')
    } else {
        next()
